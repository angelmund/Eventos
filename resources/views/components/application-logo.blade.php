<svg xmlns="http://www.w3.org/2000/svg" {{ $attributes }} class="icon icon-tabler icon-tabler-brand-coinbase" width="52"
    height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round"
