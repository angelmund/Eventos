...
<body>
		...
		<div class="portada__contenedor flex centrar-y">
			...
			<div class="portada__titulos">
				...
				<div class="titulo__cronometro">
					<p id="fechaEvento" class="fechaEvento" style="display: none;">{{$landingPageData['fecha_evento']}} {{$landingPageData['hora_evento']}}</p>
			...
			<div class="portada__info">
				<p id="info__parrafo" class="info__parrafo">
	...
	<section class="formulario">
		...
		<div class="formulario__contenedor ">
			<form id="form_registro" action="" class="formulario__registro" method="POST" enctype="multipart/form-data">
				<input type="hidden" value="{{ url('/') }}" id="url">
				<input type="hidden" value="{{$landingPage->id}}" id="id" name="id">
