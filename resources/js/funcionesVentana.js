...
export function ventanaFormulario(nombreFormulario) {
...
export function ventanaMostrarMensaje(tipo, mensaje) {
    if (tipo === 'error') {
        Swal.fire({
            icon: 'error',
            title: 'Error',
...
export function obtenerValoresFormulario(form) {
...
export function estanVaciosInputs(clase) {
...
export function verificarArchivosDeImagen(clase) {
...
export function verificarVacios() {
...
export function extraerTextoExactamente(contenido) {
